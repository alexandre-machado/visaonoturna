...
addCalendar("Calendar1", "Select Date", "mindate", "findform");
addCalendar("Calendar2", "Select Date", "maxdate", "findform");
addCalendar("Calendar3", "Select Date", "AccountExpires", "edituser");
