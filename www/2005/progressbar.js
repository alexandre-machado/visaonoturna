...
var imagesn=20;
var imagesend='../fotos/cazaum/2005_7_24';
...
txt+='<table cellpadding="0" cellspacing="0" border="0"><tr><td valign="center" width="'+barwidth+'" height="'+barheight+'" bgcolor="'+unloadedcolor+'"><center><font color="'+loadedcolor+'" size="1" face="sans-serif">Carregando imagens</font></center></td></tr></table>';
if(NS4) txt+='</layer>';
...
txt+='<table cellpadding="0" cellspacing="0" border="0"><tr><td valign="center" width="'+barwidth+'" height="'+barheight+'" bgcolor="'+loadedcolor+'"><center><font color="'+unloadedcolor+'" size="1" face="sans-serif">Carregando imagens</font></center></td></tr></table>';
...
(img+index+.complete)? dispbars() : setTimeout('checkload('+index+')', 100); //eval("document.img" + currCount + ".src=dots[1].src")
}
